        ...
        <b-row class="section3-dropdowns">
          <b-col v-for="(sentiment, index) in [true, true, false]" :key="index">
            ...
            >
              ...
              />
              <b-collapse
                :id="`collapse-section3-${index}`"
                v-model="collapse.section3[index]"
                class="mt-2"
              >
                <b-alert
                  header="Example"
          ...
          <b-row>
            ...
            >
              ...
              >
                ...
                />
                <b-collapse
                  :id="`collapse-section4-${index}`"
                  v-model="collapse.section4[index]"
                  class="mt-2"
                >
                  <b-alert
                    header="Example"
